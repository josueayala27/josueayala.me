...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-none" }, _attrs))}><section class="py-3 prose capitalize"><p></p></section><section class="prose"><h1> Title </h1><p> Description </p></section>`);
...
//# sourceMappingURL=_slug_-cff69336.mjs.map
