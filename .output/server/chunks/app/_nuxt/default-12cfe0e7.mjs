...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(_attrs)}><nav class="border-b py-4 flex justify-between"><div class="cursor-pointer inline-flex">${unref(brandLogo)}</div></nav></header>`);
    };
  }
});
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_LayoutNavigation = _sfc_main$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-[42rem] mx-auto flex flex-col min-h-[100vh] p-4" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_LayoutNavigation, null, null, _parent));
  _push(`<main class="h-full flex-1 relative">`);
...
//# sourceMappingURL=default-12cfe0e7.mjs.map
