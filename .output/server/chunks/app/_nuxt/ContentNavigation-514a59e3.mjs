...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify, a as useCookie } from './query-90e8de0b.mjs';
import { d as useState, b as useRuntimeConfig } from '../server.mjs';
import { hash } from 'ohash';
import { _ as __nuxt_component_0 } from './nuxt-link-28642a34.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-246389eb.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-514a59e3.mjs.map
