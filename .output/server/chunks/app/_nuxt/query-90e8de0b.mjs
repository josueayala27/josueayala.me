...
import { e as useNuxtApp, c as createError, b as useRuntimeConfig, f as useRequestEvent } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-246389eb.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-90e8de0b.mjs.map
