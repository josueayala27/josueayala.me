...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-cff69336.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b2ddc0e9.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-c9676cba.mjs')
};
...
const layouts = {
  default: () => import('./_nuxt/default-12cfe0e7.mjs').then((m) => m.default || m),
  error: () => import('./_nuxt/error-a0cf740e.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-964dd887.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-f7402e84.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useHead as a, useRuntimeConfig as b, createError as c, useState as d, entry$1 as default, useNuxtApp as e, useRequestEvent as f, useRouter as g, navigateTo as n, useRoute as u };
